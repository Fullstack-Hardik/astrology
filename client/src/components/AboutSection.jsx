...
const AboutSection = () => {
  ...
  return (
    <section className="relative py-32 md:py-48 px-4 sm:px-6 md:px-12 max-w-7xl mx-auto overflow-hidden bg-slate-900/40 backdrop-blur-md mt-12 rounded-[3rem] shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-slate-100/50">
      
      {/* Decorative Orbs (Parallax) */}
      <motion.div style={{ y: y1 }} className="absolute top-10 left-0 md:left-10 w-48 h-48 bg-slate-800/50 rounded-full mix-blend-multiply filter blur-3xl opacity-50" />
      <motion.div style={{ y: y2 }} className="absolute bottom-20 right-0 md:right-10 w-64 h-64 bg-slate-800/50 rounded-full mix-blend-multiply filter blur-3xl opacity-50" />
      ...
      <div className="relative z-10 flex flex-col items-center text-center">
        <motion.p 
          ...
          className="text-slate-400 font-semibold tracking-[0.3em] uppercase text-xs md:text-sm mb-6"
        >
          Our Philosophy
        </motion.p>
        ...
        >
          We bridge the gap between <span className="font-normal text-slate-400">ancient wisdom</span> and modern luxury.
        </motion.h2>
        ...
        <motion.div 
          ...
          className="mt-16 w-full max-w-2xl text-slate-200 text-lg md:text-xl leading-relaxed font-light"
        >
        ...
        >
          <img src="/images/mystic_astrology_bg_1789373287874.png" alt="Cosmic Philosophy" className="w-full h-full object-cover transition-transform duration-1000 hover:scale-105" />
