  ...
  <footer className="relative overflow-hidden bg-foreground text-background">
    ...
    <div className="container-full relative z-10 py-16 md:py-20">
      <div className="grid gap-12 border-b border-background/15 pb-14 lg:grid-cols-[1.4fr_0.6fr_0.6fr]">
        ...
        <div><h3 className="text-xs font-semibold uppercase tracking-editorial text-background/45">Connect</h3><ul className="mt-5 space-y-3 text-sm text-background/70"><li><a href="mailto:hello@divinewheeloffortune.com">Email Natasha</a></li><li><a href="#" className="inline-flex items-center gap-2"><Instagram className="h-4 w-4" /> Instagram</a></li><li><a href="#">Privacy Policy</a></li><li><a href="#">Terms of Service</a></li></ul></div>
      </div>
